...
def places_search():
    ...
    states = js_dict.get("states", None)
    cities = js_dict.get("cities", None)
    amenities = js_dict.get("amenities", None)

    if not js_dict or (not states and not cities and not amenities):
